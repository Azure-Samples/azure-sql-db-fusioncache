...
We then can use a tool like Insomnia, or command like [curl](https://curl.se/docs/httpscripting.html) or [Invoke-RestMethod](https://learn.microsoft.com/powershell/module/microsoft.powershell.utility/invoke-restmethod), or the Swagger UI (as shown in the previous image) to hit the various endpoints.
